...
def _transfer_config_to_args(args: argparse.Namespace) -> None:
    ...
    mapping = [
        ...
        ("net_deny_by_default", "net_deny_by_default"),
...
def build_cli_config(args: argparse.Namespace) -> CliConfig:
    ...
    merged: dict[str, Any] = {
        ...
        "security_mode": getattr(args, "security_mode", "off"),
        "fs_allow_roots": getattr(args, "fs_allow_roots", None),
        "fs_deny_roots": getattr(args, "fs_deny_roots", None),
        "repo_root": getattr(args, "repo_root", None),
        "workspace_root": getattr(args, "workspace_root", None),
        "net_allow_hosts": getattr(args, "net_allow_hosts", None),
        "net_deny_by_default": getattr(args, "net_deny_by_default", None),
        "proc_allow": getattr(args, "proc_allow", None),
        "proc_ignore": getattr(args, "proc_ignore", None),
