...
def _transfer_config_to_args(args: argparse.Namespace) -> None:
    ...
    mapping = [
        ...
        ("runtime_probe_bin", "runtime_probe_bin"),
        ("runtime_probe_workspace", "runtime_probe_workspace"),
        ("runtime_probe_tmpdir", "runtime_probe_tmpdir"),
        ("runtime_probe_allow_exec", "runtime_probe_allow_exec"),
        ("runtime_probe_allow_host", "runtime_probe_allow_host"),
