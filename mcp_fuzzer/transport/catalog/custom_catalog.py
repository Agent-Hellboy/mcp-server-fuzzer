...
class CustomDriverCatalog:
    ...
    def __init__(self):
        ...
        self._registry = driver_catalog

    def clear(self) -> None:
        """Clear all registered custom transports. Useful for testing."""
        # Only clear custom transports
        custom_transports = list(self._registry.list_custom_drivers().keys())
    ...
    def list_transports(self) -> dict[str, dict[str, Any]]:
        ...
        """
        return self._registry.list_custom_drivers()
    ...
    def build_driver(self, name: str, *args, **kwargs) -> TransportDriver:
        ...
        return self._registry.build_driver(name, *args, **kwargs)


# Global registry instance
custom_driver_catalog = CustomDriverCatalog()
...
def register_custom_driver(
    ...
    Args:
        ...
        factory_function: Optional factory function to create transport instances
    """
    custom_driver_catalog.register(
...
def build_custom_driver(name: str, *args, **kwargs) -> TransportDriver:
    ...
    Returns:
        Transport instance
    """
    return custom_driver_catalog.build_driver(name, *args, **kwargs)
...
def list_custom_drivers() -> dict[str, dict[str, Any]]:
    ...
    Returns:
        Dictionary mapping transport names to their information
    """
    return custom_driver_catalog.list_transports()
