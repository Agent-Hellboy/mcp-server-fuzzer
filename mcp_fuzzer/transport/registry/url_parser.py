...
if TYPE_CHECKING:
    from .registry import UnifiedTransportRegistry
...
class URLParser:
    ...
    def __init__(self, registry: UnifiedTransportRegistry | None = None):
    ...
    def set_registry(self, registry: UnifiedTransportRegistry) -> None:
    ...
    def parse(self, url_or_protocol: str, endpoint: str | None = None) -> ParsedURL:
        ...
        Returns:
            ParsedURL with structured components
        """
    ...
    def _parse_protocol_endpoint(self, protocol: str, endpoint: str) -> ParsedURL:
        """Parse protocol and endpoint into ParsedURL.
        ...
        Returns:
            ParsedURL with protocol as scheme and endpoint
        """
    ...
    def _parse_url(self, url: str) -> ParsedURL:
        """Parse a full URL into ParsedURL.
        ...
        if not scheme and "://" in url:
            ...
            scheme_part = url.split("://", 1)[0].strip().lower()
            if self._registry and self._registry.is_registered(scheme_part):
                scheme = scheme_part
